...
const passLength = prompt('Ingresar la longuitud: ');
const hasMayus = prompt('Tiene mayusculas?(y/n) ');
const hasNumbers = prompt('Tiene números?(y/n) ');
const hasSimbols = prompt('tiene símbolos?(y/n) ');
...
const passLenght = checkLenght(passLength);
password = '';
