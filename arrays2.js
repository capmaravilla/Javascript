...
const fn02 = () => console.log('Hello'); // Funcion flecha. Con una linea no necesita llaves
const fn03 = () => {
	console.log('Hello');
	console.log('Hello2');
};

const fn04 = (name) => console.log('Hello ' + name); // Con un parametro tampoco necesita los parentesis
const fn05 = (name, codigo) => console.log('Hello ' + name + codigo);
