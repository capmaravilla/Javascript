...
const defensas = ['escudo', 'casco', 'armadura'];
...
const b = armas.pop(); // Elimna y retorna el ultimo elemento
const c = armas.shift(); // Elimna y retorna el primer elemento
...
armas.fill('puños', 0, armas.length); // Rellena con un elemento, solo los elementos que existen
